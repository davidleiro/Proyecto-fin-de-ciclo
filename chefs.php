...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            Ordenar:<input type="radio" name="senso" value="ASC" checked="checked">ASC
            <input type="radio" name="senso" value="DESC">DESC
        ...
        <table class="table table-dark">
            ...
            <tr><th>Nombre</th> <th> Apellidos</th> <th> Sexo</th> <th> Nacionalidad</th> <th> Descripcion</th></tr>
