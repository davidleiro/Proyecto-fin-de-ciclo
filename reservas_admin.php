    ...
    <body>
        ...
        <ul class="circulos3">
            ...
            if (isset($_SESSION['rol'])) {
                ...
                if ($usu == 1) {
                    echo "<li><a href='reservas_admin.php'><span>Administracion reservas</span></a></li>";
                } else {

                    echo "<li><a href='reservas.php'><span>Reservar</span></a></li>";
                }
            }
            ?>
        ...
        <table class="table table-dark">
            ...
            <tr><th>IdReserva</th> <th> idUsuario</th> <th> Fecha</th> <th> Comensales</th><th>Borrar</th> </tr>
