...
$datos= cargar_info_usuario();

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nuevos_datos = $_POST;
    $pass=password_hash($nuevos_datos['password'], PASSWORD_DEFAULT);

    $modif_datos = modif_info_usuario($nuevos_datos,$pass);
}
...
if (isset($_SESSION['usuario'])) {
   ...
   echo "Bienvenid@ al Japanese Restaurant Kanewokau   <a class='cuenta'> $usu[email] </a>";
}
?>
        </span>
      ...
      <div class="container-cuenta container-fluid row">
            <div class="sidebar bg-dark col-sm-2" >


                <div class="submenu">
                    <a class="nav-item nav-link" href="cuenta.php">INFO</a>
                    <a class="nav-item nav-link" href="lista_reservas.php">Historico</a>
            ...
            <div class=" contenido col-sm-9">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                    <div class="foto form-row">
                        ...
                        <div class="col-sm-4">
                            <img src="../images/bar-hotel.jpg" width="250px" class="img-circle">

                        </div>
                    </div>
                    <div class="boton form-row">
                        <div class="col-sm-7">
                        </div>
                        <div class="col-sm-4">
                            <button type="button" class="btn btn-dark">Subir foto</button>
                        </div>
                    </div>
                    <div class="campos form-row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control-plaintext" id="Email" value="<?php echo $datos['email']; ?>" disabled="disabled">
                        </div>
                    </div>
                    <div class="campos form-row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control-plaintext" id="Nombre" name="Nombre" value="<?php echo $datos['nombre'];  ?>" disabled="disabled">
                        </div>
                    </div>
                    <div class="campos form-row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control-plaintext" id="Telefono" name="Telefono" value="<?php echo $datos['telefono'];  ?>" disabled="disabled">
                        </div>
                    </div>
                    ...
                    <div class="campos form-row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control-plaintext" id="password" name="password" value="<?php echo $datos['email']; ?>" disabled="disabled">
                        </div>
                    </div>

                    <div class="campos form-row">
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-dark" id="actu" name="actu">Modificar Info</button>

                        </div>
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-dark" id="save" name="save">Guardar</button>
                        </div>
                    </div>
    ...
    <br><br><br><br>
       ...
       <br><br><br><br>
          ...
          <script type="text/javascript">
                        ...
                        var actu = document.getElementById("actu").addEventListener("click", function () {
